<%@ Page Title="Map" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Map.aspx.cs" Inherits="ProjectPortal.Map" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
       ...
       <script>
           ...
           require(["dojo/_base/connect",
            ...
            TOC) {
                ...
                dynaLayer1 = new ArcGISDynamicMapServiceLayer("http://server:6080/arcgis/rest/services/Donlin/MapServer", {
                    opacity: 0.8
                });

                dynaLayer2 = new ArcGISDynamicMapServiceLayer("http://server:6080/arcgis/rest/services/DNRLandRecords/Ownership/MapServer", {
                    opacity: 0.8
                });
 ...
 <div class="claro">
    <div id="maindiv">
        <div id="content" data-dojo-type="dijit/layout/BorderContainer" design="headline" gutters="true" style="width: 100%; height: 820px; margin: 0;">
    ...
    <script>
        ...
        $(window).load(function () {
            $("#map_container").removeClass("container");
            $("#map_root").removeClass("container");
        });
    </script>
</asp:Content>
